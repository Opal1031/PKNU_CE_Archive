...
// find
void EventScheduler::show_relevant_events_between(Date theDay1, Date theDay2) {
	for (auto ev : events) {
		if (ev->relevant_to_between(theDay1, theDay2)) {
			ev->print(cout);
			cout << endl;
		}
	}
...
// save
void EventScheduler::save_events_file(string file_name) {
